 ...
 * Use the [NoInputsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NoInputsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NoInputsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NoInputsFragment().apply {
